...
public class AwsConsoleApp {
     ...
     *      (/Users/arunnarayanaswamy/.aws/credentials) where the sample code will load the
     *      credentials from.
    ...
    private static void init() throws Exception {
         ...
         * (/Users/arunnarayanaswamy/.aws/credentials).
         */
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (/Users/arunnarayanaswamy/.aws/credentials), and is in valid format.",
                    e);
        }
